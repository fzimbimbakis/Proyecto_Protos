...
SERVER_C_FILES = src/selector.c src/stm.c  src/socks5nio.c src/Etapas/connecting.c  src/Etapas/copy.c src/debug.c src/address_utils.c src/socket_utils.c src/buffer.c src/args.c src/main.c
all: server  client
