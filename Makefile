...
SERVER_C_FILES =   src/selector.o src/stm.o  src/socks5nio.o src/Etapas/connecting.o src/Etapas/hello.o  src/Etapas/copy.o src/debug.o src/address_utils.o src/socket_utils.o src/buffer.o src/args.o src/main.o
